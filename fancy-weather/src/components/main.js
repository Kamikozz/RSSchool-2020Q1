...
alert(`
  ...
  Наконец-то оно живое! :3
  Спасибо, что ждали.

  Доп. функционал, какой бы он ни был худо-бедный:
  - По клику на карте можно получить погоду и данные из кликнутого места;
  - Чуть-чуть более расширенный функционал говорилки;
  ...
  2) Работает говорилка на трёх языках (но не Speech Recognition);
`);
